                    ...
                    <div class="card-body">
                      ...
                      <form id="formAccountDeactivation" method="POST" action="{{ route('profile.destroy') }}">
                        ...
                        <div class="form-check mb-3">
                          <input class="form-check-input" type="checkbox" name="delete_confirmation" id="delete_confirmation" value="DELETE" required />
                          <label class="form-check-label" for="delete_confirmation">I confirm my account deactivation</label>
                        </div>
